...
{
	MagicalDamageCapture.AttributeToCapture = UCAP_AttributeSet::GetPhysicalDamageAttribute();
	MagicalDamageCapture.AttributeSource = EGameplayEffectAttributeCaptureSource::Source;

	MagicalPenetrationCapture.AttributeToCapture = UCAP_AttributeSet::GetPhysicalPenetrationAttribute();
	MagicalPenetrationCapture.AttributeSource = EGameplayEffectAttributeCaptureSource::Source;

	MagicalArmorCapture.AttributeToCapture = UCAP_AttributeSet::GetPhysicalArmorAttribute();
	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	ExecutionParams.AttemptCalculateCapturedAttributeMagnitude(MagicalDamageCapture, EvalParams, PhysicalDamage);
	ExecutionParams.AttemptCalculateCapturedAttributeMagnitude(MagicalPenetrationCapture, EvalParams, PhysicalPen);
	ExecutionParams.AttemptCalculateCapturedAttributeMagnitude(MagicalArmorCapture, EvalParams, PhysicalArmor);
